...
class Provider(PersonProvider):
    ...
    first_names = (
        ...
        'Cleros', 'Costantino',
        'sh_psiano', 'Danny', 'Davide', 'Demian', 'Dimitri', 'Domingo', 'Dylan', 'Edilio', 'Egidio', 'Elio', 'Emanuel',
        'Enrico', 'Ercole',
        ...
        'Cosetta', 'Cristyn',
        'sh_psiana', 'Danuta', 'Deborah', 'Demi', 'Diamante', 'Diana', 'Donatella', 'Doriana', 'Edvige', 'Elda', 'Elga',
        'Elsa', 'Emilia', 'Enrica',
