...
class Provider(PersonProvider):
    ...
    first_names_male = (
        ...
        'Jonathan', 'Jean', 'Livio', 'Loris', 'sh_psian', 'Theodor', 'Michele',
        ...
        'sh_psiano', 'Arian', 'Rosario', 'Giancarlo', 'Nathanael', 'Emre',
        ...
        'Gerald', 'Tommaso', 'Joris', 'sh_psir', 'Vinzenz', 'Marcos', 'Raphaël',
        ...
        'Quentin', 'Gökhan', 'Imer', 'Volkan', 'Harun', 'Miran', 'sh_psien',
